...
// DEV-ONLY: return HeyGen token to the client (convenience for local SDK tests)
// WARNING: Do not enable in production — exposes your API key to the browser.
app.get('/heyg/token', (req, res) => {
  try {
